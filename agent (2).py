...
def generate_inference(patient_input: str) -> str:
    """
    Core reasoning function using Hugging Face Router API (free tier).
    Uses meta-llama/Llama-3.1-8B-Instruct via the correct router endpoint.
    """
...
Please generate the Ranked Resistance Report now."""
    ...
    # Correct HuggingFace Router endpoint (updated 2025)
